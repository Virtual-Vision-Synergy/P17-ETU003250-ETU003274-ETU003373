        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <!-- Lien direct API -->
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/orgs/Virtual-Vision-Synergy/projects/8"><i class="fab fa-github me-1"></i> TODO LIST</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/Virtual-Vision-Synergy/P17-ETU003250-ETU003274-ETU003373"><i class="fab fa-github me-1"></i> GITHUB</a>
                    </li>
                </ul>
            </div>
        </div>
