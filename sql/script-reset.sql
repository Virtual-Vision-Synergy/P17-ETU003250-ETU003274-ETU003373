-- Script de reset complet du système bancaire
...
ALTER TABLE s4_bank_etudiant
    AUTO_INCREMENT = 1;
ALTER TABLE s4_bank_etablissement
    AUTO_INCREMENT = 1;
ALTER TABLE s4_bank_type_pret
    AUTO_INCREMENT = 1;
ALTER TABLE s4_bank_pret
    AUTO_INCREMENT = 1;
ALTER TABLE s4_bank_remboursement
    AUTO_INCREMENT = 1;
ALTER TABLE s4_bank_transaction
    AUTO_INCREMENT = 1;
...
-- Étudiants
INSERT INTO s4_bank_etudiant (nom, prenom, email, age, telephone, adresse)
VALUES ('Dupont', 'Jean', 'jean.dupont@email.com', 22, '0612345678', '123 Rue de la Paix, 75001 Paris'),
...
INSERT INTO s4_bank_etablissement (nom, adresse, telephone, email, fonds_disponibles)
VALUES ('Banque Étudiante de France', '100 Avenue de la République, 75011 Paris', '0142000000', 'contact@bef.fr',
        5000000.00);

-- Types de prêts avec différents taux
INSERT INTO s4_bank_type_pret (nom, description, taux_interet, duree_max_mois, montant_min, montant_max)
VALUES ('Prêt Étudiant Standard', 'Prêt pour financer les études supérieures', 2.50, 120, 1000.00, 50000.00),
       ('Prêt Équipement Informatique', 'Prêt pour achat d\'ordinateur et matériel informatique', 3.20, 36, 500.00,
        5000.00),
...
INSERT INTO s4_bank_transaction (etablissement_id, type_transaction, montant, solde_avant, solde_apres, description)
...
INSERT INTO s4_bank_transaction (etablissement_id, pret_id, type_transaction, montant, solde_avant, solde_apres,
                                 description)
VALUES (1, 1, 'pret_accorde', 15000.00, 5000000.00, 4985000.00, 'Prêt accordé à Jean Dupont'),
...
SET fonds_disponibles = 4983000.00
WHERE id = 1;

-- Échéanciers pour les prêts actifs (premières échéances)
INSERT INTO s4_bank_remboursement (pret_id, numero_echeance, montant_prevu, date_echeance, statut)
VALUES
...
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total)
...
INSERT INTO s4_bank_detail_interets (pret_id, etablissement_id, annee, mois, capital_restant, taux_mensuel,
                                     montant_interet)
SELECT p.id                                                       as pret_id,
       p.etablissement_id,
       YEAR(CURDATE())                                            as annee,
       MONTH(CURDATE())                                           as mois,
...
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), 52.50, 3,
        25000.00, DATE_SUB(CURDATE(), INTERVAL 1 MONTH));

-- Mois -2
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), 48.75, 3,
        25000.00, DATE_SUB(CURDATE(), INTERVAL 2 MONTH));

-- Mois -3
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), 45.20, 2,
        17000.00, DATE_SUB(CURDATE(), INTERVAL 3 MONTH));

-- Mois -4
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 4 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 4 MONTH)), 35.60, 2,
        17000.00, DATE_SUB(CURDATE(), INTERVAL 4 MONTH));

-- Mois -5
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 5 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 5 MONTH)), 31.25, 1,
        15000.00, DATE_SUB(CURDATE(), INTERVAL 5 MONTH));

-- Mois -6
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_SUB(CURDATE(), INTERVAL 6 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 6 MONTH)), 31.25, 1,
        15000.00, DATE_SUB(CURDATE(), INTERVAL 6 MONTH));

-- DÉTAILS POUR LES MOIS PRÉCÉDENTS (pour enrichir les données)
-- Mois -1 : Détails par prêt
INSERT INTO s4_bank_detail_interets (pret_id, etablissement_id, annee, mois, capital_restant, taux_mensuel,
                                     montant_interet, date_calcul)
VALUES (1, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), 14800.00,
        0.00208, 30.83, DATE_SUB(CURDATE(), INTERVAL 1 MONTH)),
       (2, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), 1920.00,
        0.00267, 5.12, DATE_SUB(CURDATE(), INTERVAL 1 MONTH)),
       (3, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)), 8000.00,
        0.00150, 12.00, DATE_SUB(CURDATE(), INTERVAL 1 MONTH));

-- Mois -2 : Détails par prêt
INSERT INTO s4_bank_detail_interets (pret_id, etablissement_id, annee, mois, capital_restant, taux_mensuel,
                                     montant_interet, date_calcul)
VALUES (1, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), 14600.00,
        0.00208, 30.42, DATE_SUB(CURDATE(), INTERVAL 2 MONTH)),
       (2, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), 1840.00,
        0.00267, 4.91, DATE_SUB(CURDATE(), INTERVAL 2 MONTH)),
       (3, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 2 MONTH)), 8000.00,
        0.00150, 12.00, DATE_SUB(CURDATE(), INTERVAL 2 MONTH));

-- Mois -3 : Seulement 2 prêts
INSERT INTO s4_bank_detail_interets (pret_id, etablissement_id, annee, mois, capital_restant, taux_mensuel,
                                     montant_interet, date_calcul)
VALUES (1, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), 14400.00,
        0.00208, 30.00, DATE_SUB(CURDATE(), INTERVAL 3 MONTH)),
       (2, 1, YEAR(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), MONTH(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)), 1760.00,
        0.00267, 4.70, DATE_SUB(CURDATE(), INTERVAL 3 MONTH));

-- DONNÉES FUTURES POUR PROJECTION (2 mois suivants)
-- Mois +1
INSERT INTO s4_bank_interets_mensuels (etablissement_id, annee, mois, montant_interets, nombre_prets_actifs,
                                       capital_total, date_calcul)
VALUES (1, YEAR(DATE_ADD(CURDATE(), INTERVAL 1 MONTH)), MONTH(DATE_ADD(CURDATE(), INTERVAL 1 MONTH)), 58.25, 3,
        25000.00, CURDATE());
